...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='AdminMaster',
            fields=[
                ('admin_un', models.CharField(max_length=8, primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            name='Media',
            fields=[
                ('m_id', models.AutoField(max_length=8, primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            name='User',
            fields=[
                ('user_un', models.AutoField(max_length=8, primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            name='videos',
            fields=[
                ('v_id', models.AutoField(max_length=8, primary_key=True, serialize=False, unique=True)),
